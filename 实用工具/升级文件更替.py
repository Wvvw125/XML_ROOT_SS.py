...
class main():
 global FA,path_0,path,path0,path1,pathstyle,FA,FB,FE,Flo,F_style
 #指定文件夹（目录及下一级子目录批量替换）
 path_0='F:/售后体系库/……【客户软件库】……/V2.0平台/【版本更新列表】/发布-1.0.0.66-2' # input修改目录
 path0 =path_0+'/skin/betterprinter'
 path =path0+'/default'
 path1='F:/售后体系库/……【客户软件库】……/V2.0平台/【版本更新列表】/控件颜色/对勾'        #材料目录
 pathstyle='F:/售后体系库/……【客户软件库】……/V2.0平台/【版本更新列表】/控件颜色/界面黑'   #外显界面风格目录控制
 FA= os.listdir(path)
 FB= os.listdir(path1)
 FE= os.listdir(path0)
