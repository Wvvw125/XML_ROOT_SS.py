...
IFontDisp = Font
__all__ = [ 'OLE_COLOR', 'OLE_XSIZE_HIMETRIC', 'FontEvents', 'Color',
           'Unchecked', 'IFont', 'FONTITALIC', 'FONTSTRIKETHROUGH',
           'OLE_YPOS_PIXELS', 'OLE_XPOS_PIXELS', 'OLE_YSIZE_HIMETRIC',
           'OLE_XPOS_CONTAINER', 'OLE_OPTEXCLUSIVE', 'FONTBOLD',
           'OLE_CANCELBOOL', 'OLE_YPOS_CONTAINER', 'OLE_XSIZE_PIXELS',
           'IFontEventsDisp', 'OLE_YPOS_HIMETRIC',
           'OLE_XPOS_HIMETRIC', 'Checked', 'Gray',
           'LoadPictureConstants', 'FONTNAME', 'FONTUNDERSCORE',
           'IPictureDisp', 'OLE_TRISTATE', 'Default', 'StdPicture',
           'OLE_XSIZE_CONTAINER', 'OLE_YSIZE_PIXELS', 'Picture',
           'OLE_YSIZE_CONTAINER', 'IPicture', 'FONTSIZE', 'Font',
           'OLE_HANDLE', 'IFontDisp', 'Monochrome', 'VgaColor',
           'StdFont', 'OLE_ENABLEDEFAULTBOOL']
