...
DefaultDirName={pf}\灵彩PTPB_W5_ct
...
[Files]
Source: "E:\5113-2H-B\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
...
Name: LCSM; Description: "灵彩W5-by"; Flags:exclusive disablenouninstallwarning
...
Name: "{userdesktop}\灵彩W5-by"; Filename: "{app}\PrintDream"; WorkingDir: "{app}"; Tasks: desktopicon
