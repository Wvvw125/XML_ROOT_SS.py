...
[Setup]
AppName= iTu
AppVerName= iTu_2H_PT_4720
AppPublisher=iTu
AppId={{{{A7CCA258-9DEF-4D3F-9309-ED552E03A1BB}}}}
AppPublisherURL=http://www.iTu.com
AppSupportURL=http://www.iTu.com
AppUpdatesURL=http://www.iTu.com
DefaultDirName={pf}\iTu2H_PT
...
OutputBaseFilename= iTu_2H_PT_4720
...
[Files]
Source: "F:\软件库\简易机器双头\iTuPT\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
...
Name: LCSM; Description: "iTu2H_PT"; Flags:exclusive disablenouninstallwarning
...
Name: "{userdesktop}\iTu2H_PT"; Filename: "{app}\BetterPrinter"; WorkingDir: "{app}"; Tasks: desktopicon
