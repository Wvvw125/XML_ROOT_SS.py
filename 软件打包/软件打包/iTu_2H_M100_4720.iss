...
[Setup]
AppName= iTu
AppVerName= iTu_2H_M100/M200/M300_4720
AppPublisher=iTu
...
OutputBaseFilename= iTu_2H_M00_4720
...
[Files]
Source: "E:\Program Files (x86)\4720_2H_WM00-200\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
...
Name: LCSM; Description: "iTuM00"; Flags:exclusive disablenouninstallwarning
...
Name: "{userdesktop}\iTuM00"; Filename: "{app}\BetterPrinter"; WorkingDir: "{app}"; Tasks: desktopicon
