...
[Files]
Source: "E:\DX5-2H-B\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
;USB驱动,根据不同的系统安装不同的驱动程
[Types]
;Name: Full ;Description:"默认安装";
;Name: Compact ;Description:"简洁安装";
;Name: Custom; Description:"自定义安装"; Flags: iscustom            {0318605F-D236-422B-9470-2FD595518F5B}
[Components]
;添加安装可选项
...
Name: LCSM; Description: "灵彩Dx5-by"; Flags:exclusive disablenouninstallwarning
...
Name: "{userdesktop}\灵彩Dx5-by"; Filename: "{app}\PrintDream"; WorkingDir: "{app}"; Tasks: desktopicon
