...
[Setup]
AppName= iTu
AppVerName= iTu_4H_S600_2806_4720
AppPublisher=iTu
AppId={{{FB95FCD7-6245-4D2C-ABF8-EDB82DCFD153}}}
AppPublisherURL=http://www.iTu.com
AppSupportURL=http://www.iTu.com
AppUpdatesURL=http://www.iTu.com
DefaultDirName={pf}\iTuS600
...
OutputBaseFilename= iTu_4H_S600_2806_4720
...
[Files]
Source: "C:\Users\Administrator\Desktop\白墨四头四工位iTUS600-2806 - 1\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
...
Name: LCSM; Description: "iTuS600"; Flags:exclusive disablenouninstallwarning
...
Name: "{userdesktop}\iTuS600"; Filename: "{app}\BetterPrinter"; WorkingDir: "{app}"; Tasks: desktopicon
