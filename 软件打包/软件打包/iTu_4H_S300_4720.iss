...
OutputBaseFilename= iTu_4H_S300_4720
...
[Files]
Source: "E:\Program Files (x86)\BetterPrinter 5113(4720)-4H-1.1\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
...
Name: LCSM; Description: "iTuS300"; Flags:exclusive disablenouninstallwarning
...
Name: "{userdesktop}\iTuS300"; Filename: "{app}\BetterPrinter"; WorkingDir: "{app}"; Tasks: desktopicon
