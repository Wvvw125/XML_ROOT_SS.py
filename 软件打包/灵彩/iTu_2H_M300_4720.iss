...
OutputBaseFilename= iTu_2H_M300_4720
...
Name: LCSM; Description: "iTuM300"; Flags:exclusive disablenouninstallwarning
...
Name: "{userdesktop}\iTuM300"; Filename: "{app}\BetterPrinter"; WorkingDir: "{app}"; Tasks: desktopicon
