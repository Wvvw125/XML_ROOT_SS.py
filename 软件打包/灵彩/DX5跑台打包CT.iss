...
[Files]
Source: "D:\Program Files\InkDream\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
;USB驱动,根据不同的系统安装不同的驱动程

[Types]
;Name: Full ;Description:"默认安装";
;Name: Compact ;Description:"简洁安装";
;Name: Custom; Description:"自定义安装"; Flags: iscustom            {FF4FDBE5-25C9-4CF3-B633-2F09DE8E8470}

;软件安装后的路径
;(根目录名)
; HKCU; Subkey: "Software\Hoson\upriper\GolInfo"; ValueType: string; ValueName: "AppPath"; ValueData: "{app}\"; Flags: deletevalue
...
Name: LCSM; Description: "灵彩Dx5-yc"; Flags:exclusive disablenouninstallwarning
...
[INI]
Filename: "{app}\PrintDream.url"; Section: "InternetShortcut"; Key: "URL"; String: "http://www.灵彩数码机械有限公司.com"
Filename: "{app}\registering.url"; Section: "InternetShortcut"; Key: "URL"; String: "http://www.灵彩数码机械有限公司.com/"
...
Name: "{userdesktop}\灵彩Dx5-yc"; Filename: "{app}\PrintDream"; WorkingDir: "{app}"; Tasks: desktopicon
...
[Run]
Filename: "{app}\vc_runtime\vcredist_x86(english).exe"; Flags: waituntilterminated;Check:Isx86
Filename: "{app}\vc_runtime\vcredist_x64(english).exe"; Flags: waituntilterminated;Check:Isx64
