...
[Files]
Source: "E:\Program Files\跑台\InkDream_新\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
...
Name: LCSM; Description: "灵彩PTPB"; Flags:exclusive disablenouninstallwarning
...
Filename: "{app}\registering.url"; Section: "InternetShortcut"; Key: "URL"; String: "http://www.灵彩数码机械有限公司.com/cn/post.asp"
...
Name: "{userdesktop}\灵彩PTPB"; Filename: "{app}\PrintDream"; WorkingDir: "{app}"; Tasks: desktopicon
