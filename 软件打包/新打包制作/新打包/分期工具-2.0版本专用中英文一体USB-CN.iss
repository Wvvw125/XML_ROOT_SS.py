...
#define OutPutName " BetterPrinterApp_分期工具领航"                    ;输出文件名
#define AppVerName  "BetterPrinterApp 2.0"                                ;系统在组件名称
#define DirName "D:\BetterPrinterApp_分期工具"                                   ;安装目录名
#define InPutFile"E:\板卡相关\V2.0\授权工具及说明\BetterPrinter_V2.0板卡_领航分期工具"  
#define AppHeight "420"        ;高
#define AppWidth  "620"        ;宽
#define DataPort  "USB2.0-USB3.0"         ;数据端口 
