#define MyAppVersion "2.0.0.0.|.1.0.0.50"                                      ;版本号    2.0.0.0._.1.0.0.47
#define OutPutName " BetterPrinterApp_606011"                             ;输出文件名
#define DirName "D:\BetterPrinterApp_TX800_6060"                                   ;安装目录名
#define InPutFile"D:\Tx800"                  ;输入目录
#define Clean_chose "Clean_6.xml"                                   ;        [config]  clean=Clean_6.xml
#define DataPort  "USB2.0"                                                ;数据端口 
#define IP ""              ;  2251      <group name="BoardIp" alias="板卡地址（IP or PID/VID）">
                                  ;  2252            <param name="BoardIp_0" alias="板卡 1" type="string" array="false" desc="网络板卡ip地址或者usb板卡PID/VID, 192.168.000.002 或 P_AAAA V_BBBB" value="0.0.0.0" />

#define SKIN_chose "1"                                                     ;        [skin ]  cur=1    0     default    1 Gray       
...
begin
    SetIniString('skin','cur','{# SKIN_chose}',ExpandConstant('{app}/System/DeviceConfig.ini')) ;  //ini 写入
    SetIniString('config','clean','{# Clean_chose}',ExpandConstant('{app}/System/DeviceConfig.ini'))  ;     
