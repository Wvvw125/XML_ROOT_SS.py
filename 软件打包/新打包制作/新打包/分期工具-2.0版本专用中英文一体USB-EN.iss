...
#define MyAppVersion "2.0.0.0.|.1.0.0.63"                                      ;版本号    2.0.0.0._.1.0.0.47
#define MyAppExeName "BetterPrinterApp.exe"                           ;运行程序
#define OutPutName " BetterPrinterApp_instalment"                    ;输出文件名
#define AppVerName  "BetterPrinterApp 2.0"                                ;系统在组件名称
#define DirName "D:\BetterPrinterApp_instalment"                                   ;安装目录名
#define InPutFile"E:\板卡相关\V2.0\授权工具及说明\BetterPrinter_V2.0板卡_印度工具"  
#define AppHeight "420"        ;高
#define AppWidth  "620"        ;宽
#define DataPort  "USB2.0-USB2.0"         ;数据端口 
...
#define AppID"BetterPrinterApp 分期工具"                 ;{94663D78-3A80-47FE-A474-2ED2CB91C82D}
...
Name: "{userdesktop}\{#MyAppName}_instalment"; Filename: "{app}\{#MyAppName}"; WorkingDir: "{app}"; Tasks: desktopicon
;附件工具桌面快捷标创建
;Name: "{userdesktop}\IP"; Filename: "{app}\IP\netscan.exe"; WorkingDir: "{app}"; Tasks: desktopicon     
Name: "{userdesktop}\LicenseDecode_en"; Filename: "{app}\LicenseDecode_en.exe"; WorkingDir: "{app}"; Tasks: desktopicon
Name: "{userdesktop}\LicenseTool_en"; Filename: "{app}\LicenseTool_en.exe"; WorkingDir: "{app}"; Tasks: desktopicon
...
Filename: "{app}\usb device\Device 3.0.exe"; Flags: waituntilterminated;
