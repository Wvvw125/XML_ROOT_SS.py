...
#define MyAppVersion "1.1.0.0.|.0.20.9.25"                                      ;版本号    2.0.0.0._.1.0.0.37
#define MyAppExeName "BetterPrinter.exe"                           ;运行程序
#define OutPutName " BetterPrinter_地面机_2H_6C_W"                            ;输出文件名
#define AppVerName  "BetterPrinter 1.1"                               ;系统在组件名称
#define DirName "D:\BetterPrinter_地面机"                            ;安装目录名
#define InPutFile"F:\售后体系库\……【客户软件库】……\V1.1平台\国内\墙体机江榕科技（张磊）\北印7色白彩地面机软件\TX800_2H_6C\TX800_2H_6C"  
#define AppHeight "420"        ;高
#define AppWidth  "620"        ;宽
#define DataPort  "USB2.0"         ;数据端口 
#define Appplat "MSVBCRT AIO 2017.03.13 X86 X64.exe"  
#define USBdevice"win10_Device 2.0"

                                
#define AppID"BetterPrinter 1.1"                 ;{94663D78-3A80-47FE-A474-2ED2CB91C82D}
#define OutPutFile "D:\Publish\Result"
#define MyAppURL ""
#define MyAppAssocName  MyAppName + " 文件"
#define MyAppAssocExt "" 
#define MyAppAssocKey StringChange(MyAppAssocName, " ", "") + MyAppAssocExt
#define  LicenseFileCN  "F:\wwx\制作\打包素材\许可协议\CN.txt"
#define  LicenseFileEN  "F:\wwx\制作\打包素材\许可协议\EN.txt"
#define  IconFile"F:\wwx\制作\打包素材\ico\\BetterPrinter.ico"
...
Source: "{#IconFile}"; DestDir: "{win}\BetterPrinterico"; Flags: ignoreversion recursesubdirs createallsubdirs
//卸载保留  uninsneveruninstall       系统不存在则安装    onlyifdoesntexist
//Source: "{#InPutFile}\*"; DestDir: "{app}"; Flags:  uninsneveruninstall 
...
Filename: "{app}\vc_runtime\{#Appplat}"; Flags: waituntilterminated;Check:Isx64
...
SubKeyName :=  'Software\Wow6432Node\Microsoft\Windows\CurrentVersion\Uninstall\{#AppID}_is1';
    RegWriteStringValue(HKLM64,SubKeyName,'DisplayIcon','C:\Windows\BetterPrinterico\BetterPrinter.ico');
  end else begin
SubKeyName :=  'Software\Microsoft\Windows\CurrentVersion\Uninstall\{#AppID}_is1';
    RegWriteStringValue(HKLM,SubKeyName,'DisplayIcon','C:\Windows\BetterPrinterico\BetterPrinter.ico');
  end;
end;
...
begin
    ...
    begin
       SetIniString('CONFIG_CFG','strLanguage','chs',ExpandConstant('{app}/Language/lgcfg.cfg'));   //ini 写入
    end 
