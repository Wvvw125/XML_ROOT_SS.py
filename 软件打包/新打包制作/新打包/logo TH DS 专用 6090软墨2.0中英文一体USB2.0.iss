#define MyAppName "PL-Printer"                                       ;运行程序名
#define MyAppPublisher "东申彩印"                    ;发布者
#define MyAppVersion "2.0.0.0.|.1.0.0.71"                                      ;版本号    2.0.0.0._.1.0.0.47
#define MyAppExeName "PL-Printer.exe"                           ;运行程序
#define OutPutName "TX800_6060_W_6C_软墨_1.0.0.71"            ;输出文件名
#define AppVerName  "BetterPrinterApp 2.0"                                ;系统在组件名称
#define DirName "D:\PL-Printer_Tx800_6060"                                   ;安装目录名
#define InPutFile"F:\售后体系库\……【客户软件库】……\V2.0平台\国内\东升龙总\BetterPrinterApp_TX800_6060-软"  
...
Source: Logo\东申\WizModernImage-Is.bmp; Flags: dontcopy
Source: PlugIn\callnsis.dll; Flags: dontcopy
Source: PlugIn\AdvSplash.dll; Flags: dontcopy
Source: Logo\东申\logo.bmp; Flags: dontcopy
