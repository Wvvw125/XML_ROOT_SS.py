...
#define MyAppVersion "2.0.0.0.|.1.0.0.69"                                      ;版本号    2.0.0.0._.1.0.0.47
#define MyAppExeName "BetterPrinterApp.exe"                           ;运行程序
#define OutPutName " BetterPrinterApp_3200_4H_TH_1.0.0.69"            ;输出文件名
#define AppVerName  "BetterPrinterApp 2.0"                                ;系统在组件名称
#define DirName "D:\BetterPrinterApp_4H"                                   ;安装目录名
#define InPutFile"F:\售后体系库\……【客户软件库】……\V2.0平台\国内\恒恒泰_无logo需求\BetterPrinter-2H-1.0.0.69\BetterPrinter-4H"  
...
#define Appplat "VCR_Hyb_x86_x64_16.10.2017.exe"  
#define USBdeviceintall   "W_Device 3.0.exe"                                  
...
Source: Logo\Logow\WizModernImage-Is.bmp; Flags: dontcopy
...
[Run]
Filename: "{app}\usb device\{#USBdeviceintall}"; Flags: waituntilterminated;
