...
#define MyAppVersion "2.0.0.0.|.1.0.0.47"                                      ;版本号    2.0.0.0._.1.0.0.37
#define MyAppExeName "BetterPrinterApp.exe"                           ;运行程序
#define OutPutName " BetterPrinterApp_TX800-4H-W-O"            ;输出文件名
#define AppVerName  "BetterPrinterApp 2.0"                               ;系统在组件名称
#define DirName "D:\BetterPrinterApp_PB"                                   ;安装目录名
#define InPutFile"F:\售后体系库\……【客户软件库】……\V2.0平台\博艺\TX800 - 副本"  
#define AppHeight "420"        ;高
#define AppWidth  "620"        ;宽
#define DataPort  "USB2.0"         ;数据端口 
#define CFGName "TX800&Xp600-4H-4C-W-O.xml"                  ;启动配置写入
...
begin
	...
	begin
      SetIniString('config','path','{#CFGName}',ExpandConstant('{app}/System/DeviceConfig.ini'));
end;
end;
