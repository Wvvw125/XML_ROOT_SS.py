...
#define OutPutName " win7_win10_Device"                       ;输出文件名
#define AppVerName  "BetterPrinter Drive USB2.0_3.0  "                     ;系统在组件名称
#define InPutFile"F:\售后体系库\USB驱动\官方驱动\USB3.0"                                ;输入文件目录
...
Filename: "{#DirName}\x86\DPInst32.exe";Flags: waituntilterminated;Check:Mysystemis('WiN10_32')
Filename: "{#DirName}\x64\DPInst64.exe"; Flags: waituntilterminated;Check:Mysystemis('WiN10_64')
