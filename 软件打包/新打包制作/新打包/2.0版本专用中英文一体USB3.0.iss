...
#define MyAppVersion "2.0.0.0.|.1.0.0.71"                                      ;版本号    2.0.0.0._.1.0.0.37
#define MyAppExeName "BetterPrinterApp.exe"                           ;运行程序
#define OutPutName " BetterPrinterApp_TX800_1H_W"                            ;输出文件名
#define AppVerName  "BetterPrinterApp 2.0"                               ;系统在组件名称
#define DirName "D:\BetterPrinterApp"                                          ;安装目录名
#define InPutFile"F:\售后体系库\……【客户软件库】……\V2.0平台\国外\Digitech\BetterPrinterApp_TX800"  
#define AppHeight "420"        ;高
#define AppWidth  "620"        ;宽
#define DataPort  "USB2.0"         ;数据端口 
#define Vc_package "VCR_Hyb_x86_x64_16.10.2017.exe"
...
//安装界面侧边图片
//WizardImageFile=F:\wwx\制作\打包素材\图1.bmp
//安装界面右上角标
...
[Run]
Filename: "{app}\usb device\{#USBDevice}"; Flags: waituntilterminated;Check:Isx64 
Filename: "{app}\vc_package\{#Vc_package}"; Flags: waituntilterminated;Check:Isx64
