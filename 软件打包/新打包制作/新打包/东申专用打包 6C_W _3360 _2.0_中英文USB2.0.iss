...
#define OutPutName " Tx800_3360_6C_W_2H_1.0.0.68"            ;输出文件名
#define AppVerName  "BetterPrinterApp 2.0"                                ;系统在组件名称
#define DirName "D:\BetterPrinterApp_3360"                                   ;安装目录名
#define  Appdeskname '3360'
#define InPutFile"F:\售后体系库\……【客户软件库】……\V2.0平台\国内\东升龙总\BetterPrinterApp_TX800_3360_6C_W"  
