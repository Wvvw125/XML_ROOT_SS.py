...
#define MyAppVersion "2.0.0.0.|.1.0.0.65"                                      ;版本号    2.0.0.0._.1.0.0.47
#define MyAppExeName "BetterPrinterApp.exe"                           ;运行程序
#define OutPutName "7610_圆柱 _1.0.0.65"            ;输出文件名
#define AppVerName  "BetterPrinterApp 2.0"                                ;系统在组件名称
#define DirName "D:\BetterPrinterApp_7610_YZ"                                   ;安装目录名
#define InPutFile"F:\售后体系库\……【客户软件库】……\V2.0平台\国内\张晔\BetterPrinterApp_7610_YZ"  
