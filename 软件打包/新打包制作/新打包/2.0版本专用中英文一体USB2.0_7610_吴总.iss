#define MyAppName "V RIP"                                       ;运行程序名
#define MyAppPublisher ""                    ;发布者
#define MyAppVersion "2.0.0.0.|.1.0.0.68"                                      ;版本号    2.0.0.0._.1.0.0.47
#define MyAppExeName "BetterPrinterApp.exe"                           ;运行程序
#define OutPutName " BetterPrinterApp_1600_2H_SJB_1.0.0.68"            ;输出文件名
#define AppVerName  "BetterPrinterApp 2.0"                                ;系统在组件名称
#define DirName "D:\V RIP_1600"                                   ;安装目录名
#define InPutFile"F:\售后体系库\……【客户软件库】……\V2.0平台\国内\鑫渝吴总\V RIP撕膜结构-1\V RIP_7610_10068"  
...
#define USBdevice"W_Device 2.0.exe"
...
Source: Logo\吴总\WizModernImage-Is.bmp; Flags: dontcopy
Source: PlugIn\callnsis.dll; Flags: dontcopy
Source: PlugIn\AdvSplash.dll; Flags: dontcopy
Source: Logo\吴总\logo.bmp; Flags: dontcopy
