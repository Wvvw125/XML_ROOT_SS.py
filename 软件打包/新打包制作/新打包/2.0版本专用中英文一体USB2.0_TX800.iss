...
#define MyAppPublisher "迈拓"                    ;发布者
#define MyAppVersion "2.0.0.0.|.1.0.0.68"                                      ;版本号    2.0.0.0._.1.0.0.47
#define MyAppExeName "BetterPrinterApp.exe"                           ;运行程序
#define OutPutName " BetterPrinterApp_1600_8H_1.0.0.68"            ;输出文件名
#define AppVerName  "BetterPrinterApp 2.0"                                ;系统在组件名称
#define DirName "D:\BetterPrinterApp_1600"                                   ;安装目录名
#define InPutFile"F:\售后体系库\……【客户软件库】……\V2.0平台\国内\迈拓数码科技\BetterPrinterApp_1600_8H_10068"  
...
#define USBdevice"Device 3.0.exe" 
