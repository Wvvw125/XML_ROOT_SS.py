...
#define MyAppVersion "2.0.0.0.|.1.0.0.66"                                      ;版本号    2.0.0.0._.1.0.0.37
#define MyAppExeName "BetterPrinterApp.exe"                           ;运行程序
#define OutPutName " BetterPrinterApp_3050_ETH_1.0.0.66"                            ;输出文件名
#define AppVerName  "BetterPrinterApp 2.0"                               ;系统在组件名称
#define DirName "D:\BetterPrinterApp_3050_ETH"                            ;安装目录名
#define InPutFile"F:\售后体系库\……【客户软件库】……\V2.0平台\国内\东升龙总\BetterPrinterApp_PB_4C_3050-ETH"  
...
;Filename: "{app}\更新说明.txt"; Description: "更新说明"; Flags: postinstall shellexec skipifsilent
 //Filename:"{cmd}";Parameters:"/c REG ADD ""HKEY_CURRENT_USER\Software\Microsoft\Windows NT\CurrentVersion\AppCompatFlags\Layers"" /v ""{app}\{#MyAppExeName}"" -t REG_SZ /d RUNASADMIN /f "; StatusMsg: "注册管理员权限..."
