...
#define OutPutName " BetterPrinterApp_i3200_2H_1.0.0.63"            ;输出文件名
#define AppVerName  "BetterPrinterApp 2.0"                                ;系统在组件名称
#define DirName "D:\BetterPrinterApp_I3200_2H_PT"                                   ;安装目录名
#define InPutFile"F:\售后体系库\……【客户软件库】……\V2.0平台\国外\埃及客户\I3200\BetterPrinterApp_I3200"  
