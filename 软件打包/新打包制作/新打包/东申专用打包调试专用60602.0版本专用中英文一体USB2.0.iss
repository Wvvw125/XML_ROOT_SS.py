...
#define MyAppVersion "2.0.0.0.|.1.0.0.64"                                      ;版本号    2.0.0.0._.1.0.0.47
#define MyAppExeName "BetterPrinterApp.exe"                           ;运行程序
#define OutPutName " 调试专用一体版_3050-4050-5050-6060_6C_Y_1.0.0.64_2"            ;输出文件名
#define AppVerName  "BetterPrinterApp 2.0"                                ;系统在组件名称
#define DirName "D:\BetterPrinterApp_TX800_6060调试专用"                                   ;安装目录名
#define InPutFile"F:\售后体系库\……【客户软件库】……\V2.0平台\国内\东升龙总\BetterPrinterApp_PB_6C_6060调机用"  
