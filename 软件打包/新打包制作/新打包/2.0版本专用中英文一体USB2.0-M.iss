...
#define MyAppVersion "2.0.0.0.|.1.0.0.49"                                      ;版本号    2.0.0.0._.1.0.0.37
#define MyAppExeName "BetterPrinterApp.exe"                           ;运行程序
#define OutPutName " BetterPrinterApp_TX800&XP600-2H"                            ;输出文件名
#define AppVerName  "BetterPrinterApp 2.0"                               ;系统在组件名称
#define DirName "D:\BetterPrinterApp"                            ;安装目录名
#define InPutFile"F:\售后体系库\……【客户软件库】……\V2.0平台\恒恒泰\BetterPrinterApp_TX800&Xp600"  
