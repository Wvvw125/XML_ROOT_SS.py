...
#define OutPutName " BetterPrinterApp__TX800_4H_1.0.0.67_调机专用"            ;输出文件名
#define AppVerName  "BetterPrinterApp 2.0"                                ;系统在组件名称
#define DirName "D:\BetterPrinterApp_TX800_调机"                                   ;安装目录名
#define InPutFile"F:\售后体系库\……【客户软件库】……\V2.0平台\国内\东升龙总\BetterPrinterApp_PB_6C_9060 - 调机"  
