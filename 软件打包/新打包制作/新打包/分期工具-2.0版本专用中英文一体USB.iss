...
#define MyAppPublisher "淘印"                    ;发布者
#define MyAppVersion "2.0.0.0.|.1.0.0.70"                                      ;版本号    2.0.0.0._.1.0.0.47
#define MyAppExeName "BetterPrinterApp.exe"                           ;运行程序
#define OutPutName " BetterPrinterApp_分期工具_淘印"                    ;输出文件名
#define AppVerName  "BetterPrinterApp 2.0"                                ;系统在组件名称
#define DirName "D:\BetterPrinterApp_分期"                                   ;安装目录名
#define InPutFile"E:\板卡相关\V2.0\授权工具及说明\BetterPrinter_V2.0板卡_淘印电子科技有限公司"  
#define AppHeight "420"        ;高
#define AppWidth  "620"        ;宽
#define DataPort  "USB2.0-USB3.0-ETH"         ;数据端口 
...
Name: "{userdesktop}\{#MyAppName}分期"; Filename: "{app}\{#MyAppName}"; WorkingDir: "{app}"; Tasks: desktopicon
;附件工具桌面快捷标创建
;Name: "{userdesktop}\IP"; Filename: "{app}\IP\netscan.exe"; WorkingDir: "{app}"; Tasks: desktopicon     
Name: "{userdesktop}\分期密码管理工具"; Filename: "{app}\LicenseDecode.exe"; WorkingDir: "{app}"; Tasks: desktopicon
Name: "{userdesktop}\分期写入工具"; Filename: "{app}\LicenseTool.exe"; WorkingDir: "{app}"; Tasks: desktopicon
