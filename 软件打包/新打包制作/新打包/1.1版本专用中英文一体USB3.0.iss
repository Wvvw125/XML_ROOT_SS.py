...
#define MyAppPublisher "新善联"                    ;发布者
#define MyAppVersion "1.0.0.0.|.1.0.0.0"                                      ;版本号    2.0.0.0._.1.0.0.37
#define MyAppExeName "BetterPrinter.exe"                           ;运行程序
#define OutPutName " BetterPrinter_4720_2H_TH"                            ;输出文件名
#define AppVerName  "BetterPrinter 1.1"                               ;系统在组件名称
#define DirName "D:\BetterPrinter_TH"                            ;安装目录名
#define InPutFile"F:\售后体系库\……【客户软件库】……\V1.1平台\国内\新善联\BetterPrinter_4720_2H_W_CN\BetterPrinter_4720_2H_W_CN"  
#define AppHeight "420"        ;高
#define AppWidth  "620"        ;宽
#define DataPort  "USB2.0"                                   ;数据端口 
#define Appplat "VCR_Hyb_x86_x64_16.10.2017.exe"            ;运行环境

#define USBDRIVE "Device 2.0.exe"              ;usb驱动
...
[Run]
Filename: "{app}\usb device\{#USBDRIVE}"; Flags: waituntilterminated;Check:Isx64 
...
begin
    ...
    begin
      SetIniString('CONFIG_CFG','strLanguage','en',ExpandConstant('{app}/Language/lgcfg.cfg'));
    end;
  end;
end;
end;
