...
#define MyAppVersion "2.0.0.0.|.1.0.0.37"                              ;版本号    2.0.0.0._.1.0.0.37
#define MyAppExeName "BetterPrinterApp.exe"                           ;运行程序
#define OutPutName " BetterPrinterAppTX800-2.21"  ;输出文件名
#define AppVerName  "BetterPrinterApp"       ;系统在组件名称
#define DirName "D:\BetterPrinterApp_X600"                          ;安装目录名
#define InPutFile"F:\售后体系库\……【客户软件库】……\V2.0平台\聚丽\BetterPrinter-4720_2H_4H"
#define AppHeight "420"        ;高
#define AppWidth  "620"        ;宽
#define DataPort  "ETH"         ;数据端口 

#define AppID"BetterPrinterApp"                 ;{94663D78-3A80-47FE-A474-2ED2CB91C82D}
