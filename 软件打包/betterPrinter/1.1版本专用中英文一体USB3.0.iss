...
#define OutPutName " BetterPrinter4720-4H-W-C-1.0"                   ;输出文件名
#define AppVerName  "BetterPrinter"                                ;系统在组件名称
#define DirName "D:\BetterPrinter_4720"                          ;安装目录名
#define InPutFile"F:\wwx使用\制作\4720(1W1C)-2H-1.1"        ;输入根目录
#define OutPutFile "D:\Publish\Result"                                 ;输出目录
#define AppID"{{⑤}}"
