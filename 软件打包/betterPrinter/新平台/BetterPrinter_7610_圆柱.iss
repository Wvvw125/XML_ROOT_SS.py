...
AppVerName= BetterPrinterApp_7610_4H_圆柱
...
DefaultDirName=D:\BetterPrinterApp_YZ 
...
OutputBaseFilename= BetterPrinterApp_7610_4H_圆柱
SolidCompression=no
...
[Files]
Source: "F:\售后体系库\客户软件库\上海卢总圆柱\卢总圆柱机版本\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
...
Name: LCSM; Description: "BetterPrinterApp_YZ"; Flags:exclusive disablenouninstallwarning
...
Name: "{userdesktop}\BetterPrinterApp_YZ"; Filename: "{app}\BetterPrinterApp"; WorkingDir: "{app}"; Tasks: desktopicon
