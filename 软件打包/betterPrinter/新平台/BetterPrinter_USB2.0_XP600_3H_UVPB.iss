...
AppVerName= BetterPrinterApp_TX800_3H-2H-1h_UVPB AppVersion= 2.10.11.50
...
DefaultDirName=D:\BetterPrinterApp_PB
...
OutputBaseFilename= BetterPrinterApp_TX800_3H-2H-1H_UVPB
...
[Files]
Source: "F:\售后体系库\客户软件库\V2.0平台\深圳广彩智能（the one）\xp600_20210721\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
...
Name: LCSM; Description: "BetterPrinterApp_PB"; Flags:exclusive disablenouninstallwarning
...
Name: "{userdesktop}\BetterPrinterApp_PB"; Filename: "{app}\BetterPrinterApp"; WorkingDir: "{app}"; Tasks: desktopicon
