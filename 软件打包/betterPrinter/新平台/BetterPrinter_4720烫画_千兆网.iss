...
AppVerName= BetterPrinterApp_4720_8H_椭圆机_ETHVersionInfoCompany=企亚数码科技有限公司
VersionInfoVersion=2.1.0.30;版本号
...
DefaultDirName=D:\BetterPrinterApp_TY 
...
OutputBaseFilename= BetterPrinterApp_4720_8H_椭圆机
SolidCompression=no
...
[Files]
Source: "F:\售后体系库\客户软件库\V2.0平台\(企亚)\4720_4H_ETH_T\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
...
Name: LCSM; Description: "BetterPrinterApp_TY"; Flags:exclusive disablenouninstallwarning
...
Name: "{userdesktop}\BetterPrinterApp_TY"; Filename: "{app}\BetterPrinterApp"; WorkingDir: "{app}"; Tasks: desktopicon
