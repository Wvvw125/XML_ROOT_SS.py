...
AppVerName= BetterPrinter_UV_PB_xp600_3H
...
OutputBaseFilename= BetterPrinter_xp600_3H_6CWV
...
[Files]
Source: "F:\客户测试集\20210509\BetterPrinter\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
...
Name: LCSM; Description: "BetterPrinter_UV"; Flags:exclusive disablenouninstallwarning
...
Name: "{userdesktop}\BetterPrinter_UV"; Filename: "{app}\BetterPrinter"; WorkingDir: "{app}"; Tasks: desktopicon
