...
OutputBaseFilename= BetterPrinter_xp600_1H_4CW_B ENg5555
SolidCompression=no
...
Name: "{group}\{cm:UninstallProgram,BetterPrinter}"; Filename: "{uninstallexe}";IconFilename:"F:\wwx使用\制作\打包素材\BetterPrinter.ico"
