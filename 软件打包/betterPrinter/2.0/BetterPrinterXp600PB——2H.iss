...
AppVerName= BetterPrinter_UV_PB_xp600_2H
;VersionInfoCompany=有限公司
VersionInfoVersion=2.1.0.16   
;版本号
...
OutputBaseFilename= BetterPrinter_xp600_2H_C_W_O
SolidCompression=no
...
[Files]
Source: "F:\售后体系库\客户软件库\V1.1平台\东莞鲁总平板uv )\BetterPrinter_PB_X600\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
...
Name: LCSM; Description: "BetterPrinter_PB"; Flags:exclusive disablenouninstallwarning
...
Name: "{userdesktop}\BetterPrinter_PB"; Filename: "{app}\BetterPrinter"; WorkingDir: "{app}"; Tasks: desktopicon
